...
class CountedIterator:
    ...
    This iterator keeps track of the number of items iterated over.overrides
    ...
    Methods:
        __init__(some_iterable):
            Initializes the CountedIterator with an iterator object sets the
            counter to zero.
        ...
        __next__():
            Overrides the __next__ method of the iterator. Increments counter
    ...
    def __next__(self):
        """Returns next item from the iterator and increments the counter."""
        try:
